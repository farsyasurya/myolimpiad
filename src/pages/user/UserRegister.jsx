    ...
    <div className="relative w-full h-full flex flex-col justify-between bg-slate-900 text-white select-none overflow-y-auto no-scrollbar">
      ...
      <div className="flex-1 p-5 max-w-md w-full mx-auto flex flex-col justify-center">
        <div className="flex flex-col items-center text-center mb-5">
          <div className="w-14 h-14 rounded-3xl bg-emerald-500/20 border-2 border-emerald-400 text-emerald-400 flex items-center justify-center mb-2 shadow-lg">
            <Sparkles className="w-8 h-8" />
          </div>
          <h2 className="text-xl font-black font-game text-emerald-300">
            Daftar Peserta Cilik
          </h2>
          <p className="text-xs text-slate-400 mt-0.5">
            Buat akun untuk mengikuti event olimpiade dan kuis
          </p>
        </div>
